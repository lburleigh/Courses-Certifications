...
dat <- read.csv("C:/Users/larn_/Desktop/ProjectWorkshop/rstats-wtf-wtf-fix-paths-637fe44/data/installed-packages.csv")
...
dat <- read.csv("rstats-wtf-wtf-fix-paths-637fe44/data/installed-packages.csv")
...
dat <- read.csv(here::here("rstats-wtf-wtf-fix-paths-637fe44/data/installed-packages.csv"))
